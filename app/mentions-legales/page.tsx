...
export const metadata = {
  title: 'Mentions légales | IA Restaurant Manager',
  description: 'Mentions légales et informations sur l\'éditeur du site IA Restaurant Manager.',
}
      ...
      <main className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
        ...
        <div className="mt-8 prose prose-neutral dark:prose-invert max-w-none text-muted-foreground text-sm space-y-8">
          <p className="text-muted-foreground">
            Les présentes mentions légales s&apos;appliquent au site internet <strong>IA Restaurant Manager</strong> et à la plateforme de gestion multi-restaurants associée. Conformément à la loi pour la confiance dans l&apos;économie numérique (LCEN), les informations ci-dessous identifient l&apos;éditeur et les conditions d&apos;utilisation du site.
          </p>
          ...
          <section>
            ...
            <p>
              L&apos;ensemble du contenu de ce site (textes, images, logos, graphismes, logiciels, bases de données, structure) est protégé par le droit d&apos;auteur, le droit des marques et le droit des bases de données. Toute reproduction, représentation, modification, diffusion ou exploitation non autorisée de tout ou partie de ce contenu, sans l&apos;accord préalable écrit d&apos;IA Restaurant Manager, est interdite et constitutive d&apos;une contrefaçon susceptible de poursuites civiles et pénales.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              IA Restaurant Manager s&apos;efforce d&apos;assurer l&apos;exactitude et la mise à jour des informations diffusées sur ce site. Toutefois, IA Restaurant Manager ne peut garantir l&apos;exactitude, la précision ou l&apos;exhaustivité des informations. En conséquence, IA Restaurant Manager décline toute responsabilité pour toute imprécision, omission ou erreur portant sur les informations disponibles sur ce site.
            </p>
            <p className="mt-2">
              L&apos;utilisation du site et de la plateforme est soumise aux conditions du contrat en vigueur. IA Restaurant Manager ne saurait être tenue responsable des dommages indirects ou des pertes de données résultant de l&apos;utilisation du service, dans les limites autorisées par la loi.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Ce site peut contenir des liens vers d&apos;autres sites. IA Restaurant Manager n&apos;exerce aucun contrôle sur ces sites et décline toute responsabilité quant à leur contenu, leur accessibilité ou leurs pratiques en matière de données personnelles. La création de liens vers ce site (notamment en framing) est soumise à l&apos;accord préalable écrit d&apos;IA Restaurant Manager.
            </p>
          </section>
