...
/** Modèle CSV pour l'import des produits (UTF-8 avec BOM, colonnes en français) */
const PRODUCTS_CSV_TEMPLATE =
  '\uFEFFnom,categorie,prix_unitaire\nCroissant,Viennoiseries,1.50\nCafé noir,Boissons,2.00\nBurger Classique,Plats,12.50'
...
export default function ImportProductsPage() {
  ...
  const canImport = permissions.canCreateProduct(currentRole)
  ...
  const handleDownloadTemplate = useCallback(() => {
    ...
    toast({
      ...
      description: 'Le fichier modele_import_produits.csv a été téléchargé. Remplissez-le puis importez-le ci-dessous.',
    })
  }, [toast])
        ...
        <div className="p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
          ...
          <Card className="rounded-xl border shadow-sm bg-card">
            <CardContent className="py-16 text-center space-y-4">
              ...
              <p className="text-muted-foreground">
                Veuillez sélectionner une organisation pour importer des produits.
              </p>
              <Button asChild variant="outline">
                <Link href="/dashboard/products">Retour aux produits</Link>
              </Button>
          ...
          <Card className="rounded-xl border shadow-sm bg-card">
            <CardHeader>
              ...
              <CardDescription className="mt-1">
                Sélectionnez le fichier CSV à importer. Les produits seront créés dans votre organisation.
              </CardDescription>
            </CardHeader>
                ...
                >
                  ...
                  {file ? (
                    ...
                    <label htmlFor="file-upload" className="cursor-pointer block space-y-2">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Format attendu : nom, categorie, prix_unitaire
                      </p>
                    </label>
                  )}
                </div>
          ...
          <CardHeader className="pb-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div>
                ...
                <CardDescription className="mt-1">
                  Votre fichier CSV doit contenir les colonnes suivantes (en français ci-dessous). Les noms en anglais (name, category, unitPrice) sont aussi acceptés. Téléchargez le modèle pour partir d&apos;un fichier prêt à remplir.
                </CardDescription>
              </div>
              <Button
                type="button"
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-xl bg-muted/30 dark:bg-gray-800/30 border border-border p-4 font-mono text-xs">
                <ul className="space-y-1 list-none p-0 m-0">
                  <li><strong>nom</strong> : Nom du produit (obligatoire, unique dans l&apos;organisation)</li>
                  <li><strong>categorie</strong> : Catégorie du produit (optionnel)</li>
                  <li><strong>prix_unitaire</strong> : Prix unitaire en euros (nombre, décimal avec point)</li>
                </ul>
              </div>
